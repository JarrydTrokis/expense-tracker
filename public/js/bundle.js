...
var ExpenseApp = function (_Component) {
  _inherits(ExpenseApp, _Component);
  ...
  function ExpenseApp() {
    ...
    _classCallCheck(this, ExpenseApp);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ExpenseApp.__proto__ || Object.getPrototypeOf(ExpenseApp)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      expenses: []
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(ExpenseApp, [{
    key: 'render',
...
(0, _reactDom.render)(_react2.default.createElement(ExpenseApp, null), document.getElementById('app'));
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '54862' + '/');
